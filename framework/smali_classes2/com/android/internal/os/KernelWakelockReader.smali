...
.method public parseProcWakelocks([BIZLcom/android/internal/os/KernelWakelockStats;)Lcom/android/internal/os/KernelWakelockStats;
    ...
    :try_end_e5
    .catchall {:try_start_57 .. :try_end_e5} :catchall_54
    ...
    .catchall {:try_start_e8 .. :try_end_10d} :catchall_54
    ...
    :try_end_11f
    .catchall {:try_start_10f .. :try_end_11f} :catchall_54
...
.method public final readKernelWakelockStats(Lcom/android/internal/os/KernelWakelockStats;)Lcom/android/internal/os/KernelWakelockStats;
    ...
    const-string/jumbo v15, "/proc/wakelocks"

    invoke-direct {v8, v15}, Ljava/io/FileInputStream;-><init>(Ljava/lang/String;)V
    :try_end_12
    .catch Ljava/io/FileNotFoundException; {:try_start_a .. :try_end_12} :catch_1d
    .catch Ljava/io/IOException; {:try_start_a .. :try_end_12} :catch_99
    ...
    invoke-virtual {v8, v2, v9, v15}, Ljava/io/FileInputStream;->read([BII)I
    :try_end_18
    .catch Ljava/io/IOException; {:try_start_13 .. :try_end_18} :catch_99
    ...
    const-string/jumbo v15, "/d/wakeup_sources"

    invoke-direct {v8, v15}, Ljava/io/FileInputStream;-><init>(Ljava/lang/String;)V
    :try_end_26
    .catch Ljava/io/FileNotFoundException; {:try_start_1e .. :try_end_26} :catch_28
    .catch Ljava/io/IOException; {:try_start_1e .. :try_end_26} :catch_99
    ...
    :try_start_29
    const-string/jumbo v15, "KernelWakelockReader"

    const-string/jumbo v16, "neither /proc/wakelocks nor /d/wakeup_sources exists"
    ...
    :try_end_37
    .catch Ljava/io/IOException; {:try_start_29 .. :try_end_37} :catch_99
    ...
    const-string/jumbo v17, "Reading wakelock stats took "
    ...
    const-string/jumbo v17, "Kernel wake locks exceeded buffer size "
    ...
    invoke-virtual {v0, v2, v9, v14, v1}, Lcom/android/internal/os/KernelWakelockReader;->parseProcWakelocks([BIZLcom/android/internal/os/KernelWakelockStats;)Lcom/android/internal/os/KernelWakelockStats;
    ...
    const-string/jumbo v16, "failed to read kernel wakelocks"

    move-object/from16 v0, v16

    invoke-static {v15, v0, v5}, Landroid/util/Slog;->wtf(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
