...
.method private ensureInitialized()V
    ...
    :try_end_20
    .catch Ljava/lang/Throwable; {:try_start_b .. :try_end_20} :catch_54
    .catchall {:try_start_b .. :try_end_20} :catchall_70
    ...
    :try_end_25
    .catch Ljava/lang/Throwable; {:try_start_22 .. :try_end_25} :catch_52
    .catch Landroid/content/res/Resources$NotFoundException; {:try_start_22 .. :try_end_25} :catch_28
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_22 .. :try_end_25} :catch_28
    .catch Ljava/io/IOException; {:try_start_22 .. :try_end_25} :catch_28
    .catch Landroid/security/net/config/XmlConfigSource$ParserException; {:try_start_22 .. :try_end_25} :catch_28
    ...
    throw v3
    :try_end_28
    .catch Landroid/content/res/Resources$NotFoundException; {:try_start_27 .. :try_end_28} :catch_28
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_27 .. :try_end_28} :catch_28
    .catch Ljava/io/IOException; {:try_start_27 .. :try_end_28} :catch_28
    .catch Landroid/security/net/config/XmlConfigSource$ParserException; {:try_start_27 .. :try_end_28} :catch_28
    .catchall {:try_start_27 .. :try_end_28} :catchall_4f
    ...
    throw v2
    :try_end_4f
    .catchall {:try_start_29 .. :try_end_4f} :catchall_4f
    ...
    .catch Landroid/content/res/Resources$NotFoundException; {:try_start_5c .. :try_end_5f} :catch_28
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_5c .. :try_end_5f} :catch_28
    .catch Ljava/io/IOException; {:try_start_5c .. :try_end_5f} :catch_28
    .catch Landroid/security/net/config/XmlConfigSource$ParserException; {:try_start_5c .. :try_end_5f} :catch_28
    ...
    throw v2
    :try_end_6e
    .catch Landroid/content/res/Resources$NotFoundException; {:try_start_61 .. :try_end_6e} :catch_28
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_61 .. :try_end_6e} :catch_28
    .catch Ljava/io/IOException; {:try_start_61 .. :try_end_6e} :catch_28
    .catch Landroid/security/net/config/XmlConfigSource$ParserException; {:try_start_61 .. :try_end_6e} :catch_28
    .catchall {:try_start_61 .. :try_end_6e} :catchall_4f
...
.method private parseDebugOverridesResource()Landroid/security/net/config/NetworkSecurityConfig$Builder;
    ...
    throw v9
    :try_end_60
    .catch Ljava/lang/Throwable; {:try_start_33 .. :try_end_60} :catch_60
    .catchall {:try_start_33 .. :try_end_60} :catchall_8c
    ...
    :try_end_6b
    .catch Ljava/lang/Throwable; {:try_start_68 .. :try_end_6b} :catch_9c
    ...
    invoke-static {v5}, Lcom/android/internal/util/XmlUtils;->skipCurrentTag(Lorg/xmlpull/v1/XmlPullParser;)V
    :try_end_91
    .catch Ljava/lang/Throwable; {:try_start_6e .. :try_end_91} :catch_60
    .catchall {:try_start_6e .. :try_end_91} :catchall_8c
...
.method private parsePin(Landroid/content/res/XmlResourceParser;)Landroid/security/net/config/Pin;
    ...
    :try_end_45
    .catch Ljava/lang/IllegalArgumentException; {:try_start_42 .. :try_end_45} :catch_7e
...
.method private parsePinSet(Landroid/content/res/XmlResourceParser;)Landroid/security/net/config/PinSet;
    ...
    throw v9
    :try_end_2a
    .catch Ljava/text/ParseException; {:try_start_f .. :try_end_2a} :catch_2a
    ...
    :try_end_37
    .catch Ljava/text/ParseException; {:try_start_34 .. :try_end_37} :catch_2a
