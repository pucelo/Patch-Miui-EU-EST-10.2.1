...
.method public static getActivityMetaData(Landroid/content/Context;Landroid/content/pm/ActivityInfo;I)Landroid/app/SearchableInfo;
    ...
    :try_end_e
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_2 .. :try_end_e} :catch_1d
...
.method private static getActivityMetaData(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;Landroid/content/ComponentName;)Landroid/app/SearchableInfo;
    ...
    :try_end_c
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_9 .. :try_end_c} :catch_d0
    .catch Ljava/io/IOException; {:try_start_9 .. :try_end_c} :catch_b0
    ...
    :try_end_24
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_14 .. :try_end_24} :catch_f1
    .catch Ljava/io/IOException; {:try_start_14 .. :try_end_24} :catch_f4
    ...
    :try_end_2c
    .catch Ljava/lang/IllegalArgumentException; {:try_start_27 .. :try_end_2c} :catch_32
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_27 .. :try_end_2c} :catch_f1
    .catch Ljava/io/IOException; {:try_start_27 .. :try_end_2c} :catch_f4

    :goto_2c
    :try_start_2c
    invoke-interface {p1}, Lorg/xmlpull/v1/XmlPullParser;->next()I
    :try_end_2f
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_2c .. :try_end_2f} :catch_d0
    .catch Ljava/io/IOException; {:try_start_2c .. :try_end_2f} :catch_b0
    ...
    invoke-static {p1}, Landroid/util/Xml;->asAttributeSet(Lorg/xmlpull/v1/XmlPullParser;)Landroid/util/AttributeSet;
    :try_end_74
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_33 .. :try_end_74} :catch_f1
    .catch Ljava/io/IOException; {:try_start_33 .. :try_end_74} :catch_f4
    ...
    :try_end_7f
    .catch Ljava/lang/IllegalArgumentException; {:try_start_77 .. :try_end_7f} :catch_81
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_77 .. :try_end_7f} :catch_f1
    .catch Ljava/io/IOException; {:try_start_77 .. :try_end_7f} :catch_f4
    ...
    invoke-static {v8, v9}, Landroid/util/Log;->w(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_af
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_82 .. :try_end_af} :catch_f1
    .catch Ljava/io/IOException; {:try_start_82 .. :try_end_af} :catch_f4
...
.method public getProviderContext(Landroid/content/Context;Landroid/content/Context;)Landroid/content/Context;
    ...
    :try_end_1a
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_14 .. :try_end_1a} :catch_1c
    .catch Ljava/lang/SecurityException; {:try_start_14 .. :try_end_1a} :catch_1e
