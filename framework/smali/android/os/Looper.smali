...
.method public static loop()V
    ...
    invoke-static {v9, v10}, Landroid/os/statistics/LooperMessageSuperviser;->beginLooperMessage(Landroid/os/ILooperMonitorable;Landroid/os/Message;)V

    iget-object v0, v10, Landroid/os/Message;->monitorInfo:Landroid/os/BaseLooper$MessageMonitorInfo;
    ...
    invoke-virtual {v9, v10, v0, v1}, Landroid/os/Looper;->updateMessageByState(Landroid/os/Message;Landroid/os/BaseLooper$MessageMonitorInfo;I)V
    ...
    :try_end_9e
    .catchall {:try_start_95 .. :try_end_9e} :catchall_1d6
    ...
    invoke-static {v9, v10, v0, v1}, Landroid/os/statistics/LooperMessageSuperviser;->endLooperMessage(Landroid/os/ILooperMonitorable;Landroid/os/Message;J)V
    ...
    invoke-static {}, Landroid/os/SystemClock;->uptimeMillis()J
    :try_end_1d3
    .catchall {:try_start_1d0 .. :try_end_1d3} :catchall_1d6
...
.method public static prepareMainLooper()V
    ...
    invoke-virtual {v0, v2}, Landroid/os/Looper;->enableAnrMonitor(Z)V
    :try_end_29
