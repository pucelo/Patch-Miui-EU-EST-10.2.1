...
.method private parseServiceMetadata(I)V
    ...
    throw v10
    :try_end_31
    .catch Ljava/lang/Throwable; {:try_start_c .. :try_end_31} :catch_31
    .catchall {:try_start_c .. :try_end_31} :catchall_99
    ...
    :try_end_3c
    .catch Ljava/lang/Throwable; {:try_start_39 .. :try_end_3c} :catch_f4
    ...
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_39 .. :try_end_3c} :catch_d5
    ...
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_3e .. :try_end_3f} :catch_3f
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_3e .. :try_end_3f} :catch_d5
    ...
    :try_end_cd
    .catch Ljava/lang/Throwable; {:try_start_5c .. :try_end_cd} :catch_31
    .catchall {:try_start_5c .. :try_end_cd} :catchall_99
    ...
    invoke-interface {v4}, Landroid/content/res/XmlResourceParser;->close()V
    :try_end_d2
    .catch Ljava/lang/Throwable; {:try_start_cf .. :try_end_d2} :catch_f2
    .catch Ljava/io/IOException; {:try_start_cf .. :try_end_d2} :catch_3f
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_cf .. :try_end_d2} :catch_3f
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_cf .. :try_end_d2} :catch_d5
    ...
    throw v11
    :try_end_d5
    .catch Ljava/io/IOException; {:try_start_d4 .. :try_end_d5} :catch_3f
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_d4 .. :try_end_d5} :catch_3f
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_d4 .. :try_end_d5} :catch_d5
    ...
    throw v10
    :try_end_102
    .catch Ljava/io/IOException; {:try_start_fc .. :try_end_102} :catch_3f
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_fc .. :try_end_102} :catch_3f
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_fc .. :try_end_102} :catch_d5
