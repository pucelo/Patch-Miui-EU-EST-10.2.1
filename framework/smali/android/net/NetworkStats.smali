...
.method private addTrafficToApplications(ILjava/lang/String;Ljava/lang/String;Landroid/net/NetworkStats$Entry;Landroid/net/NetworkStats$Entry;)Landroid/net/NetworkStats$Entry;
    ...
    iput-object p3, v8, Landroid/net/NetworkStats$Entry;->iface:Ljava/lang/String;
    ...
    iget-wide v0, p4, Landroid/net/NetworkStats$Entry;->rxBytes:J
    ...
    iget-wide v2, p5, Landroid/net/NetworkStats$Entry;->rxBytes:J

    iget-wide v4, p4, Landroid/net/NetworkStats$Entry;->rxBytes:J

    invoke-static/range {v0 .. v5}, Landroid/net/NetworkStats;->multiplySafe(JJJ)J
    ...
    :goto_37
    iget-wide v0, p4, Landroid/net/NetworkStats$Entry;->rxPackets:J
    ...
    iget-wide v2, p5, Landroid/net/NetworkStats$Entry;->rxPackets:J
    ...
    :goto_4d
    iget-wide v0, p4, Landroid/net/NetworkStats$Entry;->txBytes:J
    ...
    iget-wide v2, p5, Landroid/net/NetworkStats$Entry;->txBytes:J
    ...
    :goto_63
    iget-wide v0, p4, Landroid/net/NetworkStats$Entry;->txPackets:J
    ...
    iget-wide v2, p5, Landroid/net/NetworkStats$Entry;->txPackets:J
    ...
    :goto_79
    iget-wide v0, p4, Landroid/net/NetworkStats$Entry;->operations:J
    ...
    iget-wide v2, p5, Landroid/net/NetworkStats$Entry;->operations:J
    ...
    iput v0, v8, Landroid/net/NetworkStats$Entry;->metered:I

    iget-object v0, p0, Landroid/net/NetworkStats;->roaming:[I

    aget v0, v0, v6

    iput v0, v8, Landroid/net/NetworkStats$Entry;->roaming:I

    invoke-virtual {p0, v8}, Landroid/net/NetworkStats;->combineValues(Landroid/net/NetworkStats$Entry;)Landroid/net/NetworkStats;
    ...
    invoke-virtual {v7, v8}, Landroid/net/NetworkStats$Entry;->add(Landroid/net/NetworkStats$Entry;)V
