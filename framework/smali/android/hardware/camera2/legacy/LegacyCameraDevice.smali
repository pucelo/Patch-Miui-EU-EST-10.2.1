...
.method static containsSurfaceId(Landroid/view/Surface;Ljava/util/Collection;)Z
    ...
    :try_end_5
    .catch Landroid/hardware/camera2/legacy/LegacyExceptionUtils$BufferQueueAbandonedException; {:try_start_2 .. :try_end_5} :catch_f
...
.method public static isVideoEncoderConsumer(Landroid/view/Surface;)Z
    ...
    invoke-static {p0}, Landroid/hardware/camera2/legacy/LegacyCameraDevice;->detectSurfaceType(Landroid/view/Surface;)I
    :try_end_19
    .catch Landroid/hardware/camera2/legacy/LegacyExceptionUtils$BufferQueueAbandonedException; {:try_start_16 .. :try_end_19} :catch_1f
...
.method public close()V
    ...
    invoke-virtual {v1}, Landroid/os/HandlerThread;->join()V
    :try_end_1c
    .catch Ljava/lang/InterruptedException; {:try_start_17 .. :try_end_1c} :catch_43
...
.method public configureOutputs(Landroid/util/SparseArray;)I
    ...
    invoke-interface {v9, v14}, Ljava/util/List;->add(Ljava/lang/Object;)Z
    :try_end_f2
    .catch Landroid/hardware/camera2/legacy/LegacyExceptionUtils$BufferQueueAbandonedException; {:try_start_44 .. :try_end_f2} :catch_f3
...
.method protected finalize()V
    ...
    :try_end_3
    .catch Landroid/os/ServiceSpecificException; {:try_start_0 .. :try_end_3} :catch_7
    .catchall {:try_start_0 .. :try_end_3} :catchall_29
...
.method public submitRequestList([Landroid/hardware/camera2/CaptureRequest;Z)Landroid/hardware/camera2/utils/SubmitInfo;
    ...
    invoke-direct {v4}, Ljava/util/ArrayList;-><init>()V
    :try_end_22
    .catch Landroid/hardware/camera2/legacy/LegacyExceptionUtils$BufferQueueAbandonedException; {:try_start_19 .. :try_end_22} :catch_4b
    ...
    :try_end_49
    .catch Landroid/hardware/camera2/legacy/LegacyExceptionUtils$BufferQueueAbandonedException; {:try_start_44 .. :try_end_49} :catch_4b
