...
.method public run()V
    ...
    iget-object v2, v2, Lcom/android/server/backup/BackupManagerService$FullBackupEngine;->mOutputFile:Landroid/os/ParcelFileDescriptor;
    ...
    invoke-static/range {v8 .. v14}, Lcom/android/server/backup/BackupManagerServiceInjector;->prepareOperationTimeout(Lcom/android/server/backup/BackupManagerService;IJLcom/android/server/backup/BackupRestoreTask;II)V
    ...
    invoke-static/range {v12 .. v18}, Lcom/android/server/backup/BackupManagerServiceInjector;->doFullBackup(Landroid/app/IBackupAgent;Landroid/os/ParcelFileDescriptor;JILandroid/app/backup/IBackupManager;I)V
    :try_end_129
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_129} :catch_164
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_129} :catch_139
    .catchall {:try_start_0 .. :try_end_129} :catchall_18f
    ...
    :try_end_130
    .catch Ljava/io/IOException; {:try_start_129 .. :try_end_130} :catch_19a
    ...
    :try_end_15a
    .catchall {:try_start_13a .. :try_end_15a} :catchall_18f
    ...
    invoke-virtual {v2}, Landroid/os/ParcelFileDescriptor;->close()V
    :try_end_161
    .catch Ljava/io/IOException; {:try_start_15a .. :try_end_161} :catch_162
    ...
    invoke-static {v2, v3}, Landroid/util/Slog;->e(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_185
    .catchall {:try_start_165 .. :try_end_185} :catchall_18f
    ...
    invoke-virtual {v2}, Landroid/os/ParcelFileDescriptor;->close()V
    :try_end_18c
    .catch Ljava/io/IOException; {:try_start_185 .. :try_end_18c} :catch_18d
    ...
    :try_end_197
    .catch Ljava/io/IOException; {:try_start_190 .. :try_end_197} :catch_198
