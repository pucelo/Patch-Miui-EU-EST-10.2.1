...
.field mNeedPendingShowSurface:Z
...
.method private hideDummyVisibleWindow()V
    .registers 4
    ...
    const-string/jumbo v2, "hide by gesture"
...
.method private showDummyVisibleWindow()V
    .registers 3
    ...
    iput-boolean v1, p0, Lcom/android/server/wm/AppWindowAnimator;->mNeedPendingShowSurface:Z
...
.method private stepThumbnailAnimation(J)V
    ...
    invoke-virtual {v5, v8}, Lcom/android/server/wm/WindowAnimator;->getScreenRotationAnimationLocked(I)Lcom/android/server/wm/ScreenRotationAnimation;
...
.method stepAnimationLocked(J)Z
    ...
    iget-boolean v4, p0, Lcom/android/server/wm/AppWindowAnimator;->mNeedPendingShowSurface:Z

    if-eqz v4, :cond_56

    invoke-direct {p0}, Lcom/android/server/wm/AppWindowAnimator;->showDummyVisibleWindow()V
    ...
    iget-boolean v4, p0, Lcom/android/server/wm/AppWindowAnimator;->mIsDummyAnimating:Z
    ...
    invoke-virtual {v4, v8}, Lcom/android/server/wm/MiuiGestureController;->setKeepWallpaperShowing(Z)V

    :cond_ca
    iput-boolean v8, p0, Lcom/android/server/wm/AppWindowAnimator;->mIsDummyAnimating:Z

    iget-boolean v4, p0, Lcom/android/server/wm/AppWindowAnimator;->mIsDummyVisible:Z

    if-eqz v4, :cond_df

    invoke-direct {p0}, Lcom/android/server/wm/AppWindowAnimator;->hideDummyVisibleWindow()V
