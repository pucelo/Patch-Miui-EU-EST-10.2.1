...
.method constructor <init>(Lcom/android/server/pm/PackageManagerService;Landroid/content/pm/PackageParser$Package;IIILjava/lang/String;Landroid/content/pm/IPackageDataObserver;)V
    ...
    iput-object p2, p0, Lcom/android/server/pm/PackageManagerService$15;->val$pkg:Landroid/content/pm/PackageParser$Package;

    iput p3, p0, Lcom/android/server/pm/PackageManagerService$15;->val$callingUid:I

    iput p4, p0, Lcom/android/server/pm/PackageManagerService$15;->val$hasAccessInstantApps:I

    iput p5, p0, Lcom/android/server/pm/PackageManagerService$15;->val$userId:I

    iput-object p6, p0, Lcom/android/server/pm/PackageManagerService$15;->val$packageName:Ljava/lang/String;

    iput-object p7, p0, Lcom/android/server/pm/PackageManagerService$15;->val$observer:Landroid/content/pm/IPackageDataObserver;
...
.method public run()V
    ...
    iget-object v5, p0, Lcom/android/server/pm/PackageManagerService$15;->val$pkg:Landroid/content/pm/PackageParser$Package;
    ...
    iget v5, p0, Lcom/android/server/pm/PackageManagerService$15;->val$callingUid:I
    ...
    iget v5, p0, Lcom/android/server/pm/PackageManagerService$15;->val$hasAccessInstantApps:I
    ...
    iget-object v7, p0, Lcom/android/server/pm/PackageManagerService$15;->val$pkg:Landroid/content/pm/PackageParser$Package;

    iget v8, p0, Lcom/android/server/pm/PackageManagerService$15;->val$userId:I

    const/16 v9, 0x103

    invoke-static {v5, v7, v8, v9}, Lcom/android/server/pm/PackageManagerService;->-wrap28(Lcom/android/server/pm/PackageManagerService;Landroid/content/pm/PackageParser$Package;II)V
    ...
    invoke-static {v5, v6, v7, v10}, Lcom/android/server/pm/PackageManagerService;->-wrap29(Lcom/android/server/pm/PackageManagerService;Ljava/lang/String;IZ)V
