...
.method private createDefaultChannelIfNeeded(Lcom/android/server/notification/RankingHelper$Record;)V
    ...
    iget-object v3, p1, Lcom/android/server/notification/RankingHelper$Record;->channels:Ljava/util/Map;
...
.method private getPackageChannels()Ljava/util/Map;
    ...
    iget-object v6, v5, Lcom/android/server/notification/RankingHelper$Record;->channels:Ljava/util/Map;
...
.method public deleteNotificationChannelGroup(Ljava/lang/String;ILjava/lang/String;)Ljava/util/List;
    ...
    :cond_12
    iget-object v4, v3, Lcom/android/server/notification/RankingHelper$Record;->groups:Ljava/util/Map;
    ...
    invoke-virtual {v1, v4}, Landroid/app/NotificationChannel;->setDeleted(Z)V
...
.method public dumpJson(Lcom/android/server/notification/NotificationManagerService$DumpFilter;)Lorg/json/JSONObject;
    ...
    :cond_91
    iget-object v11, v7, Lcom/android/server/notification/RankingHelper$Record;->channels:Ljava/util/Map;
...
.method public getNotificationChannelGroups(Ljava/lang/String;IZ)Landroid/content/pm/ParceledListSlice;
    ...
    invoke-direct {v4, v8, v8}, Landroid/app/NotificationChannelGroup;-><init>(Ljava/lang/String;Ljava/lang/CharSequence;)V
    ...
    iget-object v6, v5, Lcom/android/server/notification/RankingHelper$Record;->groups:Ljava/util/Map;
    ...
    :cond_6e
    invoke-virtual {v3, v1}, Landroid/app/NotificationChannelGroup;->addChannel(Landroid/app/NotificationChannel;)V

    goto :goto_23

    :cond_72
    invoke-virtual {v4, v1}, Landroid/app/NotificationChannelGroup;->addChannel(Landroid/app/NotificationChannel;)V
...
.method public readXml(Lorg/xmlpull/v1/XmlPullParser;Z)V
    ...
    :try_end_74
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_6c .. :try_end_74} :catch_1be
    ...
    :try_end_196
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_18f .. :try_end_196} :catch_198
...
.method public writeXml(Lorg/xmlpull/v1/XmlSerializer;Z)V
    ...
    :try_end_bd
    .catchall {:try_start_16 .. :try_end_bd} :catchall_be
    ...
    iget-object v8, v7, Lcom/android/server/notification/RankingHelper$Record;->channels:Ljava/util/Map;
    ...
    :try_end_110
    .catchall {:try_start_c1 .. :try_end_110} :catchall_be
