...
.method private closeAndCleanupJobLocked(ZLjava/lang/String;)V
    ...
    invoke-virtual {v2, v0, v3}, Lcom/android/server/job/JobPackageTracker;->noteInactive(Lcom/android/server/job/controllers/JobStatus;I)V
    ...
    :try_end_2e
    .catch Landroid/os/RemoteException; {:try_start_17 .. :try_end_2e} :catch_57
    ...
    iput-object v6, p0, Lcom/android/server/job/JobServiceContext;->mWakeLock:Landroid/os/PowerManager$WakeLock;

    iput-object v6, p0, Lcom/android/server/job/JobServiceContext;->mRunningJob:Lcom/android/server/job/controllers/JobStatus;

    iput-object v6, p0, Lcom/android/server/job/JobServiceContext;->mRunningCallback:Lcom/android/server/job/JobServiceContext$JobCallback;

    iput-object v6, p0, Lcom/android/server/job/JobServiceContext;->mParams:Landroid/app/job/JobParameters;

    iput v7, p0, Lcom/android/server/job/JobServiceContext;->mVerb:I

    const/4 v2, 0x0

    iput-boolean v2, p0, Lcom/android/server/job/JobServiceContext;->mCancelled:Z

    iput-object v6, p0, Lcom/android/server/job/JobServiceContext;->service:Landroid/app/job/IJobService;
...
.method executeRunnableJob(Lcom/android/server/job/controllers/JobStatus;)Z
    ...
    :try_end_16
    .catchall {:try_start_7 .. :try_end_16} :catchall_116
    ...
    invoke-static {v0, v2, v14, v1}, Lcom/android/server/am/JobServiceContextInjector;->bindService(Lcom/android/server/job/JobServiceContext;Landroid/content/Context;Landroid/content/Intent;Lcom/android/server/job/controllers/JobStatus;)Z
    ...
    :try_end_e2
    .catchall {:try_start_1a .. :try_end_e2} :catchall_116
    ...
    :try_end_fa
    .catch Landroid/os/RemoteException; {:try_start_eb .. :try_end_fa} :catch_119
    .catchall {:try_start_eb .. :try_end_fa} :catchall_116
    ...
    :try_end_113
    .catchall {:try_start_fa .. :try_end_113} :catchall_116
