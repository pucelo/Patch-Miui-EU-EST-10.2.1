...
.field private final mHourlyHelper:Lcom/android/server/usage/UsageStatsHourlyHelper;
...
.method constructor <init>(Landroid/content/Context;ILjava/io/File;Lcom/android/server/usage/UserUsageStatsService$StatsUpdatedListener;)V
    ...
    new-instance v0, Lcom/android/server/usage/UsageStatsHourlyHelper;

    invoke-direct {v0, p1, p3, p2}, Lcom/android/server/usage/UsageStatsHourlyHelper;-><init>(Landroid/content/Context;Ljava/io/File;I)V

    iput-object v0, p0, Lcom/android/server/usage/UserUsageStatsService;->mHourlyHelper:Lcom/android/server/usage/UsageStatsHourlyHelper;
...
.method private loadActiveStats(J)V
    ...
    iget-object v2, p0, Lcom/android/server/usage/UserUsageStatsService;->mHourlyHelper:Lcom/android/server/usage/UsageStatsHourlyHelper;

    invoke-virtual {v2, p1, p2}, Lcom/android/server/usage/UsageStatsHourlyHelper;->loadActiveHourlyStats(J)V
...
.method private notifyStatsChanged()V
    ...
    iget-object v0, p0, Lcom/android/server/usage/UserUsageStatsService;->mHourlyHelper:Lcom/android/server/usage/UsageStatsHourlyHelper;

    iget-boolean v1, p0, Lcom/android/server/usage/UserUsageStatsService;->mStatsChanged:Z

    invoke-virtual {v0, v1}, Lcom/android/server/usage/UsageStatsHourlyHelper;->setStatsChanged(Z)V
...
.method init(J)V
    ...
    iget-object v6, p0, Lcom/android/server/usage/UserUsageStatsService;->mHourlyHelper:Lcom/android/server/usage/UsageStatsHourlyHelper;

    invoke-virtual {v6, p1, p2}, Lcom/android/server/usage/UsageStatsHourlyHelper;->init(J)V
...
.method onTimeChanged(JJ)V
    ...
    invoke-virtual {v0, v2, v3}, Lcom/android/server/usage/UsageStatsHourlyHelper;->onTimeChanged(J)V
...
.method persistActiveStats()V
    ...
    invoke-virtual {v2}, Lcom/android/server/usage/UsageStatsHourlyHelper;->persistActiveHourlyStats()V
    :try_end_3a
...
.method queryUsageStats(IJJ)Ljava/util/List;
    ...
    iget-object v1, p0, Lcom/android/server/usage/UserUsageStatsService;->mHourlyHelper:Lcom/android/server/usage/UsageStatsHourlyHelper;
    ...
    invoke-virtual/range {v1 .. v7}, Lcom/android/server/usage/UsageStatsHourlyHelper;->queryStats(JJILcom/android/server/usage/UsageStatsDatabase$StatCombiner;)Ljava/util/List;
...
.method reportEvent(Landroid/app/usage/UsageEvents$Event;)V
    ...
    iget-object v5, p0, Lcom/android/server/usage/UserUsageStatsService;->mHourlyHelper:Lcom/android/server/usage/UsageStatsHourlyHelper;

    invoke-virtual {v5, p1}, Lcom/android/server/usage/UsageStatsHourlyHelper;->reportHourlyEvent(Landroid/app/usage/UsageEvents$Event;)V
