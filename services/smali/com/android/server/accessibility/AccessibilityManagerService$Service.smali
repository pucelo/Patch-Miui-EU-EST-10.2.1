...
.method public findAccessibilityNodeInfoByAccessibilityId(IJILandroid/view/accessibility/IAccessibilityInteractionConnectionCallback;IJLandroid/os/Bundle;)Z
    ...
    :try_end_16
    .catchall {:try_start_f .. :try_end_16} :catchall_92
    ...
    :try_end_2d
    .catchall {:try_start_1c .. :try_end_2d} :catchall_92
    ...
    :try_end_38
    .catchall {:try_start_33 .. :try_end_38} :catchall_92
    ...
    :try_end_57
    .catchall {:try_start_3e .. :try_end_57} :catchall_92
    ...
    :try_end_82
    .catch Landroid/os/RemoteException; {:try_start_6d .. :try_end_82} :catch_95
    .catchall {:try_start_6d .. :try_end_82} :catchall_a6
...
.method public findAccessibilityNodeInfosByText(IJLjava/lang/String;ILandroid/view/accessibility/IAccessibilityInteractionConnectionCallback;J)Z
    ...
    invoke-direct/range {p0 .. p0}, Lcom/android/server/accessibility/AccessibilityManagerService$Service;->isCalledForCurrentUserLocked()Z
    :try_end_16
    .catchall {:try_start_f .. :try_end_16} :catchall_93
    ...
    invoke-virtual {v3, v0, v5}, Lcom/android/server/accessibility/AccessibilityManagerService$SecurityPolicy;->canGetAccessibilityNodeInfoLocked(Lcom/android/server/accessibility/AccessibilityManagerService$Service;I)Z
    :try_end_2d
    .catchall {:try_start_1c .. :try_end_2d} :catchall_93
    ...
    invoke-static {v3, v5}, Lcom/android/server/accessibility/AccessibilityManagerService;->-wrap0(Lcom/android/server/accessibility/AccessibilityManagerService;I)Landroid/view/MagnificationSpec;
    :try_end_57
    .catchall {:try_start_3e .. :try_end_57} :catchall_93
    ...
    :try_end_83
    .catch Landroid/os/RemoteException; {:try_start_6d .. :try_end_83} :catch_96
    .catchall {:try_start_6d .. :try_end_83} :catchall_a7
...
.method public findFocus(IJIILandroid/view/accessibility/IAccessibilityInteractionConnectionCallback;J)Z
    ...
    invoke-direct/range {p0 .. p0}, Lcom/android/server/accessibility/AccessibilityManagerService$Service;->isCalledForCurrentUserLocked()Z
    :try_end_11
    .catchall {:try_start_e .. :try_end_11} :catchall_94
    ...
    :try_end_39
    .catchall {:try_start_34 .. :try_end_39} :catchall_94
    ...
    :try_end_58
    .catchall {:try_start_3f .. :try_end_58} :catchall_94
    ...
    :try_end_84
    .catch Landroid/os/RemoteException; {:try_start_6e .. :try_end_84} :catch_97
    .catchall {:try_start_6e .. :try_end_84} :catchall_a8
...
.method public focusSearch(IJIILandroid/view/accessibility/IAccessibilityInteractionConnectionCallback;J)Z
    ...
    invoke-direct/range {p0 .. p0}, Lcom/android/server/accessibility/AccessibilityManagerService$Service;->isCalledForCurrentUserLocked()Z
    :try_end_11
    .catchall {:try_start_e .. :try_end_11} :catchall_8e
    ...
    invoke-virtual {v3, v0, v5}, Lcom/android/server/accessibility/AccessibilityManagerService$SecurityPolicy;->canGetAccessibilityNodeInfoLocked(Lcom/android/server/accessibility/AccessibilityManagerService$Service;I)Z
    :try_end_28
    .catchall {:try_start_17 .. :try_end_28} :catchall_8e
    ...
    invoke-direct {v0, v5}, Lcom/android/server/accessibility/AccessibilityManagerService$Service;->getConnectionLocked(I)Landroid/view/accessibility/IAccessibilityInteractionConnection;
    :try_end_33
    .catchall {:try_start_2e .. :try_end_33} :catchall_8e
    ...
    invoke-static {v3, v5}, Lcom/android/server/accessibility/AccessibilityManagerService;->-wrap0(Lcom/android/server/accessibility/AccessibilityManagerService;I)Landroid/view/MagnificationSpec;
    :try_end_52
    .catchall {:try_start_39 .. :try_end_52} :catchall_8e
    ...
    :try_end_7e
    .catch Landroid/os/RemoteException; {:try_start_68 .. :try_end_7e} :catch_91
    .catchall {:try_start_68 .. :try_end_7e} :catchall_a2
...
.method public getMagnificationRegion()Landroid/graphics/Region;
    ...
    invoke-static {}, Landroid/os/Binder;->clearCallingIdentity()J
    :try_end_20
    .catchall {:try_start_13 .. :try_end_20} :catchall_38
...
.method public onServiceConnected(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    :try_end_1d
    .catch Landroid/os/RemoteException; {:try_start_17 .. :try_end_1d} :catch_5e
    .catchall {:try_start_17 .. :try_end_1d} :catchall_89
    ...
    invoke-static {v3, p0, v2}, Lcom/android/server/accessibility/AccessibilityManagerService;->-wrap16(Lcom/android/server/accessibility/AccessibilityManagerService;Lcom/android/server/accessibility/AccessibilityManagerService$Service;Lcom/android/server/accessibility/AccessibilityManagerService$UserState;)V
    ...
    invoke-virtual {v3, v5, p0}, Lcom/android/server/accessibility/AccessibilityManagerService$MainHandler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;

    move-result-object v3

    invoke-virtual {v3}, Landroid/os/Message;->sendToTarget()V
    :try_end_5c
    .catchall {:try_start_1d .. :try_end_5c} :catchall_89
    ...
    :try_end_68
    .catchall {:try_start_5f .. :try_end_68} :catchall_89

    :try_start_68
    invoke-virtual {p0}, Lcom/android/server/accessibility/AccessibilityManagerService$Service;->binderDied()V
    :try_end_6b
    .catch Ljava/util/NoSuchElementException; {:try_start_68 .. :try_end_6b} :catch_6d
...
.method public performAccessibilityAction(IJILandroid/os/Bundle;ILandroid/view/accessibility/IAccessibilityInteractionConnectionCallback;J)Z
    ...
    invoke-direct/range {p0 .. p0}, Lcom/android/server/accessibility/AccessibilityManagerService$Service;->isCalledForCurrentUserLocked()Z
    :try_end_e
    .catchall {:try_start_b .. :try_end_e} :catchall_d2
    ...
    :try_end_27
    .catchall {:try_start_14 .. :try_end_27} :catchall_d2
    ...
    :try_end_34
    .catchall {:try_start_2d .. :try_end_34} :catchall_d2
    ...
    :try_end_8c
    .catchall {:try_start_47 .. :try_end_8c} :catchall_d2
    ...
    :try_end_c7
    .catch Landroid/os/RemoteException; {:try_start_96 .. :try_end_c7} :catch_d5
    .catchall {:try_start_96 .. :try_end_c7} :catchall_da
...
.method public resetLocked()V
    ...
    :try_end_f
    .catch Landroid/os/RemoteException; {:try_start_2 .. :try_end_f} :catch_1f
    ...
    invoke-interface {v1, p0, v6}, Landroid/os/IBinder;->unlinkToDeath(Landroid/os/IBinder$DeathRecipient;I)Z
    ...
    iput-boolean v6, p0, Lcom/android/server/accessibility/AccessibilityManagerService$Service;->mReceivedAccessibilityButtonCallbackSinceBind:Z
