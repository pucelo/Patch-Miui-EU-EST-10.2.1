...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    :try_end_58
    .catch Landroid/os/RemoteException; {:try_start_4e .. :try_end_58} :catch_67
    ...
    iput-boolean v2, p0, Lcom/android/server/media/MediaRouterService;->mGlobalBluetoothA2dpOn:Z
    :try_end_65
    .catchall {:try_start_5e .. :try_end_65} :catchall_72
...
.method private registerClientLocked(Landroid/media/IMediaRouterClient;IILjava/lang/String;IZ)V
    ...
    :try_end_34
    .catch Landroid/os/RemoteException; {:try_start_31 .. :try_end_34} :catch_4e
...
.method public registerClientAsUser(Landroid/media/IMediaRouterClient;Ljava/lang/String;I)V
    ...
    monitor-exit v9
    :try_end_49
    .catchall {:try_start_48 .. :try_end_49} :catchall_52
...
.method restoreBluetoothA2dp()V
    ...
    monitor-enter v2
    :try_end_4
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_4} :catch_31

    :try_start_4
    iget-boolean v0, p0, Lcom/android/server/media/MediaRouterService;->mGlobalBluetoothA2dpOn:Z
    :try_end_6
    ...
    invoke-interface {v2, v0}, Landroid/media/IAudioService;->setBluetoothA2dpOn(Z)V
    ...
    throw v3
    :try_end_31
    .catch Landroid/os/RemoteException; {:try_start_6 .. :try_end_31} :catch_31
    ...
    const-string/jumbo v3, "RemoteException while calling setBluetoothA2dpOn."
...
.method restoreRoute(I)V
    ...
    :try_end_2d
    .catchall {:try_start_4 .. :try_end_2d} :catchall_3a
    ...
    :try_end_39
    .catch Landroid/os/RemoteException; {:try_start_34 .. :try_end_39} :catch_3d
