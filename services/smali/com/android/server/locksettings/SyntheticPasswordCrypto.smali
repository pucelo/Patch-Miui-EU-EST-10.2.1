...
.method public static createBlob(Ljava/lang/String;[B[BJ)[B
    ...
    invoke-static {p2, v6, p1}, Lcom/android/server/locksettings/SyntheticPasswordCrypto;->encrypt([B[B[B)[B

    move-result-object v2

    invoke-static {v5, v2}, Lcom/android/server/locksettings/SyntheticPasswordCrypto;->encrypt(Ljavax/crypto/SecretKey;[B)[B
    :try_end_6c
    .catch Ljava/security/cert/CertificateException; {:try_start_0 .. :try_end_6c} :catch_6e
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_6c} :catch_6e
    .catch Ljavax/crypto/BadPaddingException; {:try_start_0 .. :try_end_6c} :catch_6e
    .catch Ljavax/crypto/IllegalBlockSizeException; {:try_start_0 .. :try_end_6c} :catch_6e
    .catch Ljava/security/KeyStoreException; {:try_start_0 .. :try_end_6c} :catch_6e
    .catch Ljavax/crypto/NoSuchPaddingException; {:try_start_0 .. :try_end_6c} :catch_6e
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_0 .. :try_end_6c} :catch_6e
    .catch Ljava/security/InvalidKeyException; {:try_start_0 .. :try_end_6c} :catch_6e
...
.method public static decryptBlob(Ljava/lang/String;[B[B)[B
    ...
    invoke-static {p2, v4, v2}, Lcom/android/server/locksettings/SyntheticPasswordCrypto;->decrypt([B[B[B)[B
    :try_end_1b
    .catch Ljava/security/cert/CertificateException; {:try_start_0 .. :try_end_1b} :catch_1d
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_1b} :catch_1d
    .catch Ljavax/crypto/BadPaddingException; {:try_start_0 .. :try_end_1b} :catch_1d
    .catch Ljavax/crypto/IllegalBlockSizeException; {:try_start_0 .. :try_end_1b} :catch_1d
    .catch Ljava/security/KeyStoreException; {:try_start_0 .. :try_end_1b} :catch_1d
    .catch Ljavax/crypto/NoSuchPaddingException; {:try_start_0 .. :try_end_1b} :catch_1d
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_0 .. :try_end_1b} :catch_1d
    .catch Ljava/security/InvalidKeyException; {:try_start_0 .. :try_end_1b} :catch_1d
    .catch Ljava/security/UnrecoverableKeyException; {:try_start_0 .. :try_end_1b} :catch_1d
    .catch Ljava/security/InvalidAlgorithmParameterException; {:try_start_0 .. :try_end_1b} :catch_1d
