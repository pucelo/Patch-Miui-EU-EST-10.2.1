.class public Lcom/android/keyguard/util/AsyncSensorManager;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/keyguard/util/AsyncSensorManager;->sHandlerThread:Landroid/os/HandlerThread;
...
.method public constructor <init>(Landroid/hardware/SensorManager;)V
    ...
    iput-object p1, p0, Lcom/android/keyguard/util/AsyncSensorManager;->mInner:Landroid/hardware/SensorManager;

    sget-object v0, Lcom/android/keyguard/util/AsyncSensorManager;->sHandlerThread:Landroid/os/HandlerThread;
    ...
    sget-object v1, Lcom/android/keyguard/util/AsyncSensorManager;->sHandlerThread:Landroid/os/HandlerThread;
    ...
    iput-object v0, p0, Lcom/android/keyguard/util/AsyncSensorManager;->mHandler:Landroid/os/Handler;

    iget-object v0, p0, Lcom/android/keyguard/util/AsyncSensorManager;->mInner:Landroid/hardware/SensorManager;
    ...
    iput-object v0, p0, Lcom/android/keyguard/util/AsyncSensorManager;->mSensorCache:Ljava/util/List;
...
.method protected cancelTriggerSensorImpl(Landroid/hardware/TriggerEventListener;Landroid/hardware/Sensor;Z)Z
    ...
    iget-object v0, p0, Lcom/android/keyguard/util/AsyncSensorManager;->mHandler:Landroid/os/Handler;

    new-instance v1, Lcom/android/keyguard/util/-$Lambda$16hnwPw_q9zjGcP7iQE4UO7QjCE$1;

    const/4 v2, 0x0

    invoke-direct {v1, v2, p0, p1, p2}, Lcom/android/keyguard/util/-$Lambda$16hnwPw_q9zjGcP7iQE4UO7QjCE$1;-><init>(BLjava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
...
.method protected getFullSensorList()Ljava/util/List;
    ...
    iget-object v0, p0, Lcom/android/keyguard/util/AsyncSensorManager;->mSensorCache:Ljava/util/List;
...
.method synthetic lambda$-com_android_keyguard_util_AsyncSensorManager_2616(Landroid/hardware/SensorEventListener;Landroid/hardware/Sensor;IILandroid/os/Handler;)V
    .locals 6
...
.method synthetic lambda$-com_android_keyguard_util_AsyncSensorManager_3751(Landroid/hardware/SensorManager$DynamicSensorCallback;Landroid/os/Handler;)V
    .locals 1
...
.method synthetic lambda$-com_android_keyguard_util_AsyncSensorManager_3947(Landroid/hardware/SensorManager$DynamicSensorCallback;)V
    .locals 1
...
.method synthetic lambda$-com_android_keyguard_util_AsyncSensorManager_4142(Landroid/hardware/TriggerEventListener;Landroid/hardware/Sensor;)V
    .locals 3
...
.method synthetic lambda$-com_android_keyguard_util_AsyncSensorManager_4596(Landroid/hardware/TriggerEventListener;Landroid/hardware/Sensor;)V
    .locals 3
...
.method synthetic lambda$-com_android_keyguard_util_AsyncSensorManager_5315(Landroid/hardware/SensorAdditionalInfo;)V
    .locals 1
...
.method synthetic lambda$-com_android_keyguard_util_AsyncSensorManager_5516(Landroid/hardware/Sensor;Landroid/hardware/SensorEventListener;)V
    .locals 1
...
.method protected registerListenerImpl(Landroid/hardware/SensorEventListener;Landroid/hardware/Sensor;ILandroid/os/Handler;II)Z
    ...
    iget-object v7, p0, Lcom/android/keyguard/util/AsyncSensorManager;->mHandler:Landroid/os/Handler;

    new-instance v0, Lcom/android/keyguard/util/-$Lambda$16hnwPw_q9zjGcP7iQE4UO7QjCE$2;
    ...
    invoke-direct/range {v0 .. v6}, Lcom/android/keyguard/util/-$Lambda$16hnwPw_q9zjGcP7iQE4UO7QjCE$2;-><init>(IILjava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
...
.method protected setOperationParameterImpl(Landroid/hardware/SensorAdditionalInfo;)Z
    ...
    new-instance v1, Lcom/android/keyguard/util/-$Lambda$16hnwPw_q9zjGcP7iQE4UO7QjCE;

    const/4 v2, 0x0

    invoke-direct {v1, v2, p0, p1}, Lcom/android/keyguard/util/-$Lambda$16hnwPw_q9zjGcP7iQE4UO7QjCE;-><init>(BLjava/lang/Object;Ljava/lang/Object;)V
...
.method protected unregisterListenerImpl(Landroid/hardware/SensorEventListener;Landroid/hardware/Sensor;)V
    ...
    invoke-direct {v1, v2, p0, p2, p1}, Lcom/android/keyguard/util/-$Lambda$16hnwPw_q9zjGcP7iQE4UO7QjCE$1;-><init>(BLjava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
