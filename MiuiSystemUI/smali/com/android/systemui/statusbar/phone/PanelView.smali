...
.field private mStopTrackingAndCollapsed:Z
...
.method private endMotionEvent(Landroid/view/MotionEvent;FFZ)V
    ...
    iget-boolean v8, p0, Lcom/android/systemui/statusbar/phone/PanelView;->mTracking:Z

    if-eqz v8, :cond_0

    iget-boolean v8, p0, Lcom/android/systemui/statusbar/phone/PanelView;->mTouchSlopExceeded:Z
    ...
    invoke-interface {v8, v9}, Lcom/android/systemui/statusbar/phone/VelocityTrackerInterface;->computeCurrentVelocity(I)V
    ...
    invoke-interface {v8}, Lcom/android/systemui/statusbar/phone/VelocityTrackerInterface;->getXVelocity()F
    ...
    invoke-interface {v10}, Lcom/android/systemui/statusbar/phone/VelocityTrackerInterface;->getYVelocity()F
    ...
    :cond_2
    iget-boolean v8, p0, Lcom/android/systemui/statusbar/phone/PanelView;->mStopTrackingAndCollapsed:Z

    if-nez v8, :cond_a

    invoke-virtual {p0, v6, v5, p2, p3}, Lcom/android/systemui/statusbar/phone/PanelView;->flingExpands(FFFF)Z
    ...
    iget-boolean v4, p0, Lcom/android/systemui/statusbar/phone/PanelView;->mStopTrackingAndCollapsed:Z

    :goto_1
    iget-boolean v8, p0, Lcom/android/systemui/statusbar/phone/PanelView;->mTouchAboveFalsingThreshold:Z
    ...
    invoke-virtual {v9}, Lcom/android/systemui/statusbar/phone/StatusBar;->isFalsingThresholdNeeded()Z
    ...
    invoke-virtual {v10}, Lcom/android/systemui/statusbar/phone/StatusBar;->isWakeUpComingFromTouch()Z

    move-result v10

    invoke-static {v1, v8, v9, v10}, Lcom/android/systemui/doze/DozeLog;->traceFling(ZZZZ)V
    ...
    invoke-virtual {v8}, Lcom/android/systemui/statusbar/phone/StatusBar;->getDisplayDensity()F
    ...
    invoke-virtual {v8, v9, v10, v3, v7}, Lcom/android/systemui/statusbar/phone/LockscreenGestureLogger;->write(Landroid/content/Context;III)V
    ...
    invoke-virtual {v8}, Lcom/android/systemui/statusbar/phone/StatusBar;->isKeyguardSecure()Z
    ...
    iget-boolean v8, p0, Lcom/android/systemui/statusbar/phone/PanelView;->mExpanding:Z
    ...
    invoke-virtual {v8}, Lcom/android/systemui/statusbar/phone/StatusBar;->showBouncer()V
    ...
    iget-boolean v8, p0, Lcom/android/systemui/statusbar/phone/PanelView;->mPanelClosedOnDown:Z

    if-eqz v8, :cond_d

    iget-boolean v8, p0, Lcom/android/systemui/statusbar/phone/PanelView;->mHasLayoutedSinceDown:Z
    ...
    iget-boolean v8, p0, Lcom/android/systemui/statusbar/phone/PanelView;->mUpdateFlingOnLayout:Z

    if-eqz v8, :cond_6

    iput v6, p0, Lcom/android/systemui/statusbar/phone/PanelView;->mUpdateFlingVelocity:F
    ...
    iput-boolean v8, p0, Lcom/android/systemui/statusbar/phone/PanelView;->mPeekTouching:Z
    ...
    iget-object v8, p0, Lcom/android/systemui/statusbar/phone/PanelView;->mHeadsUpManager:Lcom/android/systemui/statusbar/policy/HeadsUpManager;
    ...
    new-instance v8, Lcom/android/systemui/statusbar/phone/PanelView$4;

    invoke-direct {v8, p0}, Lcom/android/systemui/statusbar/phone/PanelView$4;-><init>(Lcom/android/systemui/statusbar/phone/PanelView;)V

    invoke-virtual {p0, v8}, Lcom/android/systemui/statusbar/phone/PanelView;->post(Ljava/lang/Runnable;)Z
    ...
    invoke-virtual {p0, v6, v1, v8}, Lcom/android/systemui/statusbar/phone/PanelView;->fling(FZZ)V
    ...
    invoke-virtual {p0, v8}, Lcom/android/systemui/statusbar/phone/PanelView;->onEmptySpaceClick(F)Z
...
.method protected abstract isInCenterScreen()Z
.end method
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {p0}, Lcom/android/systemui/statusbar/phone/PanelView;->isInCenterScreen()Z
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iput-boolean v11, p0, Lcom/android/systemui/statusbar/phone/PanelView;->mStopTrackingAndCollapsed:Z
...
.method public stopTrackingAndCollapsed()V
    .locals 1

    const/4 v0, 0x1

    iput-boolean v0, p0, Lcom/android/systemui/statusbar/phone/PanelView;->mStopTrackingAndCollapsed:Z
